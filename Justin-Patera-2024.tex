...
\photoR{2.8cm}{Paren-Shroom}
% \photoL{2.5cm}{Yacht_High,Suitcase_High}

\personalinfo{%
  % Not all of these are required!
  \email{justinpatera@hotmail.com}
  \phone{772-643-3621}
...
\cvachievement{\faTrophy}{Husband \& Father of two}{Married over 10 years and eldest in grade school}

\divider

\cvachievement{\faHeartbeat}{GitHub Hacktoberfest}{2017, 2018, 2019, 2020 and 2021.  Excercism.io Common Lisp path \& Apollo-11 code transcription}
...
\cvsection{\faHeart Technologies}
